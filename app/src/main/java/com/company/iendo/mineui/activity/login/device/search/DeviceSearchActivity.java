...
//        saveDataToDB(position);
        ...
        if ("0".equals(accept)) {
            sendSocketPointMsg(putBean, receiveType, receiveID);
        } else if ("1".equals(accept)) {
            checkInPutPassword(item, position, putBean, receiveType, receiveID);
    ...
    private void sendSocketPointMsg(PutInBean putBean, String receiveType, String receiveID) {
    ...
    private void checkInPutPassword(BroadCastReceiveBean item, int position, PutInBean putBean, String receiveType, String receiveID) {
...
//            @Override
//            public void onSuccess(String str, InetAddress ip) {
////                String str = "AAC501006A22EE0700000000000000005618B1F96D92837Ca1f9432b11b93e8bb4ae34539b7472c20eFD7b227469746c65223a2241494f2d454e54222c2272656d61726b223a226f6e65686f6d65222c22656e646f74797065223a2233222c22616363657074223a2230227db4DD";
...
//                    if (!mReceiveBroadCastList.contains(mRun2End4)) {
////                    //此处获取到Data数据
////                    //转成Bean对象
