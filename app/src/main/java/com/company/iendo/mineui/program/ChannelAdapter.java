package com.company.iendo.mineui.program;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<ProgramEntity> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;
    // 其他频道点击事件
    private OnMyOtherChannelItemClickListener mOtherChannelItemClickListener;


    public ChannelAdapter(Context context, ItemTouchHelper helper, List<ProgramEntity> mMyChannelItems, List<ProgramEntity> mOtherChannelItems) {
    ...
    public List<ProgramEntity> getMyChannelItems(){
        return mMyChannelItems;
    }
    public List<ProgramEntity> getMyOtherChannelItems(){
...
//                                mChannelItemClickListener.onItemClick(v, position - COUNT_PRE_MY_HEADER);
//                            } else {
//                                mChannelItemClickListener.onItemToast(v, position - COUNT_PRE_MY_HEADER);
//                            }
                ...
                otherHolder.textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (isEditMode) {  //编辑状态
                            ...
                            if (null!=mOtherChannelItemClickListener){
                                int position = otherHolder.getAdapterPosition();
                                mOtherChannelItemClickListener.onOtherItemClick(v, mOtherChannelItems.get(position - mMyChannelItems.size()-COUNT_PRE_OTHER_HEADER));
//
                            }
                        }
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        ProgramEntity item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        ProgramEntity item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ProgramEntity item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
    ...
    public interface  OnMyOtherChannelItemClickListener{
        void onOtherItemClick(View v, ProgramEntity otherEntity);
    }
    public void setOnMyOtherChannelItemClickListener(OnMyOtherChannelItemClickListener listener) {
        this.mOtherChannelItemClickListener = listener;
    }
    /**
     * 我的频道
     */
