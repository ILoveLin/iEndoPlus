...
public class SharePreferenceUtil {
    ...
    public static final String Current_Chose_CaseID = "Current_Chose_CaseID";    //当前选中的病例ID,弃用了使用MMKM存储了
    ...
    public static final String Current_Login_UserName = "login_username";  //登录用户的username,弃用了使用MMKM存储了
...
//    public static final String Current_MainID = "Current_MainID";                    //设备主键ID--//这个主键ID是需要绑定用户表中的deviceID,确保是这个设备下,离线模式能通过此字段查询绑定用户
    ...
    public static final String Current_Type_Msg = "Current_Type_Msg";                //当前设备类型的描述,比如:1号内镜室
    /**
