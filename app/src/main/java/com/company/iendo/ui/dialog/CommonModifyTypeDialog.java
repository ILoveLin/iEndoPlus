 ...
 */
public final class CommonModifyTypeDialog {

    @SuppressWarnings("unchecked")
    public static class Builder<B extends CommonModifyTypeDialog.Builder<?>>
        ...
        public Builder(Context context) {
            ...
            setContentView(R.layout.ui_dialog2_shape);
            setAnimStyle(BaseDialog.ANIM_IOS);
            setGravity(Gravity.CENTER);

            mContainerLayout = findViewById(R.id.ll_ui_container1);
