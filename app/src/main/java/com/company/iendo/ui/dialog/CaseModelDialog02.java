 ...
 * desc   : 菜单选择框
 */
public final class CaseModelDialog02 {
...
//            }
            ...
            Toast.makeText(mContext, (String) mAdapter.getItem(position), Toast.LENGTH_SHORT).show();
//            mListener.onSelected(getDialog(), position, mAdapter.getItem(position));
            ...
            mBean.setMirrorSee(mMirrorSee.getText() + "");
            mBean.setMirrorDiagnostics(mMirrorDiagnostics.getText() + "");
            mBean.setAdvice(mAdvice.getText() + "");
