...
//        mTitleHeight = DensityUtils.dp2px(mContext, 62);


        mTextPaint.setTextSize(DensityUtils.sp2px(mContext, 16));
        mLineWidth = DensityUtils.dp2px(mContext, 1);
        mTitleHeight = DensityUtils.dp2px(mContext, 40);
//        mTitleHeight = DensityUtils.dp2px(mContext, mContext.getResources().getDimension(R.dimen.dp_35));
//        mTitleHeight = DensityUtils.dp2px(mContext, 50);
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        c.drawText(c1, DensityUtils.dp2px(mContext,mContext.getResources().getDimension(R.dimen.sp_7)), mTitleHeight / 2 + rect.height() / 2, mTextPaint);
